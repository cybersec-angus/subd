...
Within the next 12 months, I intend to implement the following features to make SUBD even better for everyone. 
 ...
 - Fix the email sending functionality, and include validation for the connection to the server. Also need to find a way of storing passwords and email details more securely, so these aren't being entered on the command line. 
## Disclaimer
